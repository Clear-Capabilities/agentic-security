...
| `bench/cve-replay/` | Real-CVE replay corpus + runner. 126 entries (3 regression + 123 capability), all `pre:TP post:TN`; target 500. Baseline-gated via `npm run bench:cve-replay:check` (`bench/cve-replay/CONTRIBUTING.md`). |  |
