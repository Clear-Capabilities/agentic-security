...
4. **PNG/SVG/PDF export** (#4) — large; technical question resolved (a
   ...
   (multi-view capture, SVG-element disambiguation, Chrome discovery)
   named in that doc.
