...
6. **Regulatory Obligation Overlay + evidence packs** (#6) — large,
   ...
   architecture — not yet planned) / 6c (evidence-pack export — not
   yet planned). `governanceRefs` is NOT a real signal yet (see own
