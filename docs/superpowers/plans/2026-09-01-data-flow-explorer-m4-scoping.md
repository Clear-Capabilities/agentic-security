...
9. **Data-Flow Time Machine + drift detection** (#8) — split into 8a
   ...
   classification + drift policies + CLI wiring — COMPLETE, 2026-09-02).
   Deliverable #8 (8a + 8b) is now fully done. See the row's own
